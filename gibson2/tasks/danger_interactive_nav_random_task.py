...
class DangerInteractiveNavRandomTask(PointNavRandomTask):
    ...
    def __init__(self, env):
        super(DangerInteractiveNavRandomTask, self).__init__(env)
    ...
    def load_all_interactive_objects(self, env):
        ...
        for obj_inst_name in obj_dirs:
            ...
            obj = ArticulatedObject(obj_path) # TODO: instead of this, just make a bunch of cubes
    ...
    def reset_scene(self, env):
        ...
        :param env: environment instance
        """
        super(DangerInteractiveNavRandomTask, self).reset_scene(env)
    ...
    def reset_agent(self, env):
        ...
        :param env: environment instance
        """
        super(DangerInteractiveNavRandomTask, self).reset_agent(env)
        if self.offline_eval:
    ...
    def step(self, env):
        super(DangerInteractiveNavRandomTask, self).step(env)
